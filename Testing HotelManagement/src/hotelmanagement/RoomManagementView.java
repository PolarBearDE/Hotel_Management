...
public class RoomManagementView {
    ...
    public RoomManagementView(List<Room> rooms, RoomPriceManager priceManager) {
        ...
        JButton deleteRoomButton = createStyledButton("Delete Room");
        deleteRoomButton.addActionListener(e -> deleteRoom());

        JButton exportPdfButton = createStyledButton("Export to PDF");
        exportPdfButton.addActionListener(e -> exportToPdf());

        JButton refreshButton = createStyledButton("Refresh View");
    ...
    private JButton createStyledButton(String text) {
        ...
        button.setBackground(new Color(68, 150, 255));
        ...
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                button.setBackground(new Color(40, 122, 219));
            }
