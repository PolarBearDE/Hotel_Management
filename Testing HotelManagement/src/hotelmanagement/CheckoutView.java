...
public class CheckoutView extends JFrame {
    ...
    public CheckoutView() {
        ...
        reservationComboBox.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        reservationComboBox.setBackground(new Color(240, 240, 240));
        reservationComboBox.setForeground(Color.DARK_GRAY);
        reservationComboBox.setBorder(BorderFactory.createLineBorder(new Color(200, 200, 200), 1));
        ...
        receiptTextArea.setBackground(new Color(245, 245, 245));
        receiptTextArea.setForeground(Color.DARK_GRAY);
        ...
        generateReceiptButton.setBackground(new Color(0, 123, 255));
        ...
        sendToPoliceButton.setFont(new Font("Arial", Font.BOLD, 14));
        sendToPoliceButton.setBackground(new Color(255, 69, 0));
        sendToPoliceButton.setForeground(Color.WHITE);
        sendToPoliceButton.setBorderPainted(false);
        sendToPoliceButton.setFocusPainted(false);
        ...
        generatePDFButton.setFont(new Font("Arial", Font.BOLD, 14));
        generatePDFButton.setBackground(new Color(0, 123, 255));
